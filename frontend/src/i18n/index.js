...
export const I18N = {
  zh: {
    ...
    'nav.referrals':'Abmahnung','nav.commissions':'职级薪酬',
    'nav.dispatch':'派遣需求','nav.talent':'人才储备池',
  ...
  en: {
    ...
    'nav.referrals':'Referrals/Abmahnung','nav.commissions':'Commissions',
    'nav.dispatch':'Dispatch Demands','nav.talent':'Talent Pool',
  ...
  de: {
    ...
    'nav.quotations':'Angebote','nav.referrals':'Abmahnung','nav.commissions':'Vergütung',
    'nav.dispatch':'Einsatzplanung','nav.talent':'Talentpool',
